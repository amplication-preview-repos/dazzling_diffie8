...
export class QueueControllerBase {
  ...
  @common.Patch("/:id/finish-service")
  @swagger.ApiOkResponse({
    type: Queue,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async FinishQueueService(
    @common.Body()
    body: Queue
  ): Promise<Queue> {
    return this.service.FinishQueueService(body);
  }

  @common.Patch("/:id/start-service")
  @swagger.ApiOkResponse({
    type: Queue,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async StartQueueService(
    ...
    return this.service.StartQueueService(body);
  }
}
