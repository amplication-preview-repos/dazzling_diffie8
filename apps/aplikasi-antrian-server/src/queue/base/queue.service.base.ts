...
export class QueueServiceBase {
  ...
  async CreateQueue(args: QueueCreateInput): Promise<Queue> {
    throw new Error("Not implemented");
  }
  async FinishQueueService(args: Queue): Promise<Queue> {
    throw new Error("Not implemented");
  }
  async StartQueueService(args: Queue): Promise<Queue> {
    throw new Error("Not implemented");
  }
}
